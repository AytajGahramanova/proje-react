      ...
      <div className="container">
        <div className="wrapper">
          <div className="left">
            <div>
              <img
                src="https://cdn-icons-png.flaticon.com/256/1509/1509494.png"
                alt=""
              />
            </div>
            <p
            ...
            <div className="accardion">
              <Accordion>
                ...
                <AccordionDetails>
                  <Typography style={{ color: "rgb(0,0,0,0.5)" }}>
                    ...
                    voluptatum, eligendi ipsam atque assumenda odit, perferendis
                    dicta.
                  </Typography>
                </AccordionDetails>
              </Accordion>
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  <Typography>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Consequatur quibusdam architecto vitae provident saepe omnis
                    dignissimos corporis ratione nihil. Laboriosam nesciunt
                    fugiat modi quis, odio tempora enim ipsa consequuntur
                    temporibus.
                  </Typography>
                </AccordionDetails>
              </Accordion>
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  <Typography>
                    ...
                    aliquid qui nulla, provident ratione doloremque porro atque
                    repellendus perspiciatis est. Accusamus earum, animi quod?
                  </Typography>
                </AccordionDetails>
              </Accordion>
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  <Typography>
                    ...
                    ea, et repellendus reprehenderit dolores, hic at in. Fugit..
                  </Typography>
                </AccordionDetails>
              </Accordion>
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  <Typography>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Quas sequi nobis beatae nesciunt fugit quisquam culpa rerum
                    ipsum quibusdam impedit, sed soluta, quos neque reiciendis,
                    earum magni laudantium iure, deleniti?
                  </Typography>
                </AccordionDetails>
              </Accordion>
            </div>
